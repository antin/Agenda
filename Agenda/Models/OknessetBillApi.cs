...
public class OknessetBillAgendaList
    {
    ...
    public class OknessetBillAgendas
    {
        public List<OknessetBillAgendaList> agenda_list { get; set; }
    ...
    public class OknessetBillProposal
    {
    ...
    public class RootObjectOknessetBill
    {
        public OknessetBillAgendas agendas { get; set; }
        public string stage_date { get; set; }
        public List<string> tags { get; set; }
        public string absolute_url { get; set; }
        public object explanation { get; set; }
        public string title { get; set; }
        public List<OknessetBillProposal> proposals { get; set; }
